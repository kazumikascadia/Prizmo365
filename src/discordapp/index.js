...
const { token, devToken } = require('./config.json'), deployment = require('./deploy-commands');
...
console.log(chalk.yellowBright('[STARTING]'), 'Beginning functions...');
